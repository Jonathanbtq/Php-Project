        ...
        if ($task['id_projet'] === $_GET['update']) { ?>
            <form method="POST" id="edit_task_form" class="form--Secondary" action="">
                <table class="table_task">  
                    ...
                    <tr class="ligne">
                        <td><select name="priorite">
                            ...
                            if ($task['priorite'] === 'tres_important'){?>
                                ...
                                <?php } else if ($task['priorite'] === 'important') {?>
                    ...
                    <tr>
                        <td class="ligne"><textarea name="description" form="form_task"><?= $task['description']?></textarea></td>
                ...
                <div class="modif">
                    ...
                    <input type="submit" name="deleteTask" class="submit submit--Secondary submit-Ter" value="Supprimer"> <!---Redirige vers ProjectController--->
                </div>
            </form>
            <?php 
            if ($task['id_cycle'] != 3) { ?>
